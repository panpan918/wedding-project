    ...
    <div class="about">
        ...
        <div class="middle">
            ...
            <div class="middle-right">
                <div class="right-a">
                    <div class="right-a-a">普通顾客详细信息</div>
                    <div class="right-b">
                        <el-table :data="userbList.filter(data => !search || data.username.toLowerCase().includes(search.toLowerCase()))" style="width: 100%" :border="true" :stripe="true">
                ...
                <div class="custor-a-right">
                    ...
                    <div class="custor-total">客户数量 : {{userbList.length}}</div>
                    <div class="custor-name">执行人 : {{}}</div>
                    <div class="custor-money">温馨提示<br>此页办理普通客户</div>
                </div>
...
export default {
    ...
    methods:{
        handleDelete(index, row) {
            console.log(this.userbList[index].username);
            this.usernames = this.userbList[index].username;
            this.sexs = this.userbList[index].sex;
            this.phones = this.userbList[index].phone;
            this.typess = this.userbList[index].types;
            this.balaces = this.userbList[index].balace;
            this.allBalace = this.userbList[index].spend;
            this.timeOut = this.userbList[index].times;
        },
        shat:function(){
        ...
        addCustomer:function(){
            ...
            this.userbList.push({username:this.textName,sex:this.textSex,phone:this.textPhone,types:this.textTypes,balace:this.textBalace,spend:0,times:timeo});
            this.textName = "";
            this.textSex = "";
            this.textPhone = "";
            this.textBalace = "";
